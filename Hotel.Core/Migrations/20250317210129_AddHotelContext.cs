    ...
    public partial class AddHotelContext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 3, 17, 23, 1, 28, 337, DateTimeKind.Local).AddTicks(1492), null, false, "Wifi" },
                    { 2, new DateTime(2025, 3, 17, 23, 1, 28, 337, DateTimeKind.Local).AddTicks(1560), null, false, "TV" },
                    { 3, new DateTime(2025, 3, 17, 23, 1, 28, 337, DateTimeKind.Local).AddTicks(1566), null, false, "Mini Bar" },
                    { 4, new DateTime(2025, 3, 17, 23, 1, 28, 337, DateTimeKind.Local).AddTicks(1571), null, false, "air conditioning" }
                });
