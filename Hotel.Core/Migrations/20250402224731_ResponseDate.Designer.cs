...
namespace Hotel.Core.Migrations
{
    ...
    [Migration("20250402224731_ResponseDate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel.Core.Entities.HotelStaffs.HotelStaff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel.Core.Entities.RoleFeatures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel.Core.Entities.Rooms.Facility", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 2, 22, 47, 28, 66, DateTimeKind.Utc).AddTicks(5514),
                            Deleted = false,
                            Name = "Wifi"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 4, 2, 22, 47, 28, 66, DateTimeKind.Utc).AddTicks(5524),
                            Deleted = false,
                            Name = "TV"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 4, 2, 22, 47, 28, 66, DateTimeKind.Utc).AddTicks(5525),
                            Deleted = false,
                            Name = "Mini Bar"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 4, 2, 22, 47, 28, 66, DateTimeKind.Utc).AddTicks(5527),
                            Deleted = false,
            ...
            modelBuilder.Entity("Hotel.Core.Entities.OfferModel.Offer", b =>
                {
                    b.HasOne("Hotel.Core.Entities.HotelStaffs.HotelStaff", "CreatedByStaff")
                        .WithMany()
            ...
            modelBuilder.Entity("Hotel.Core.Entities.Rooms.RoomStaff", b =>
                {
                    ...
                    b.HasOne("Hotel.Core.Entities.HotelStaffs.HotelStaff", "hotelStaff")
                        .WithMany()
